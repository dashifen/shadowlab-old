 ...
 */
class MartialArtsTechniques extends AbstractDomain
{
    /**
     * @var MartialArtsTechniquesFilter
     */
    protected $filter;

    /**
     * @var MartialArtsTechniquesFactory
     */
    protected $factory;

    /**
     * @var MartialArtsTechniquesGateway
     */
    protected $gateway;
     ...
     */
    public function getMartialArtsTechniques()
    {
        try {
            $techniques = $this->gateway->select();
            return $techniques !== false
                ? $this->payload->found([ 'techniques' => $techniques ])
                : $this->payload->notFound([ 'techniques' => '' ]);
        } catch (\Exception $e) {
    ...
    {
        if ($filter instanceof MartialArtsTechniquesFilter) $this->filter = $filter;
    ...
    {
        if ($factory instanceof MartialArtsTechniquesFactory) $this->factory = $factory;
    ...
    {
        if ($gateway instanceof MartialArtsTechniquesGateway) $this->gateway = $gateway;
