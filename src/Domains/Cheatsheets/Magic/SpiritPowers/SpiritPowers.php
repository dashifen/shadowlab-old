 ...
 */
class SpiritPowers extends AbstractDomain
{
    /**
     * @var SpiritPowersFilter
     */
    protected $filter;

    /**
     * @var SpiritPowersFactory
     */
    protected $factory;

    /**
     * @var SpiritPowersGateway
     */
    protected $gateway;
     ...
     */
    public function getSpiritPowers()
    {
        try {
    ...
    {
        if ($filter instanceof SpiritPowersFilter) $this->filter = $filter;
    ...
    {
        if ($factory instanceof SpiritPowersFactory) $this->factory = $factory;
    ...
    {
        if ($gateway instanceof SpiritPowersGateway) $this->gateway = $gateway;
